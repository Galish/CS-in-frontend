import asynq from './asynq'

describe('Async/await with Generators', () => {

	it('Waits for values (like await does)', () => {
	...
	it('Ends the function if the error is not captured', () => {
	...
	it('Returns a promise with the returned value', () => {
		return asynq(function*() {
